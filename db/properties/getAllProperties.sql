...
-- p.id = u.post_id;
select p.id, p.property_title, p.address, p.lat, p.lng, p.city, p.beds, p.baths, p.description, p.amen_1, p.amen_2, p.amen_3, p.price, p.user_id, u.image_url, users.user_email
